...
export const ToolTip = (props) => {
  ...
  return (
    <div className=' ms-5 bg-dark bg-gradient border rounded z-index ' style={{ width: "auto", height: "auto", position: "absolute", top: "2px", left: "40%", right: "-50px", zIndex: "5", color: "whitesmoke" }} >
