    ...
    return (
        <nav className="navbar fixed-top navbar-expand-lg ps-sm-2 ps-lg-5 navbar-light bg-light mb-0 pb-0" style={{ height: "60px" }}>
            ...
            <div className="container-lg  ms-xl-4 ps-xl-3 w-100 " style={{ marginTop: "0px", paddingTop: "0px" }} >
                ...
                <div className='d-flex me-sm-5 me-lg-4 mt-xl-1  ' style={{ position: "relative" }} >
                    ...
                    <input class="form-control h-25 mt-sm-1 mt-lg-2 me-1" value={searchText} type="search " onChange={(e) => setSearchText(e.target.value)} placeholder="Search movie" aria-label="Search" />

                    <div className='me-1' style={{ position: "absolute", top: "48px", width: "200px", right: "1%", cursor: "pointer" }} >
                        {
